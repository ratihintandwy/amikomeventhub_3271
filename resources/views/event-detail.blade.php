...
<main class="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 lg:grid-cols-3 gap-12">
    ...
    <div class="lg:col-span-2 space-y-12">
        ...
        <div>
            ...
            <p class="text-lg text-slate-600 leading-relaxed">Nikmati malam yang tak terlupakan dengan alunan jazz dari musisi internasional. Jazz Night 2024 hadir untuk membawa Anda ke dalam perjalanan melodi yang menenangkan dan ritme yang menggugah jiwa.</p>
            <p class="text-lg text-slate-600 leading-relaxed mt-4">Tahun ini kami menghadirkan <strong>The Jazz Collective</strong>, <strong>Luna Vance</strong>, dan artis favorit lainnya.</p>
        </div>
        ...
        <div class="bg-indigo-600 rounded-[2.5rem] p-8 md:p-12 text-white shadow-2xl shadow-indigo-200 relative overflow-hidden">
            <div class="relative z-10 flex flex-col md:flex-row justify-between items-center gap-8">
                ...
                <div>
                    <a href="{{ route('checkout') }}" class="inline-block px-10 py-5 bg-white text-indigo-600 rounded-2xl font-black text-xl hover:scale-105 transition-transform shadow-xl">
                        Pesan Sekarang
                    </a>
                </div>
            </div>
